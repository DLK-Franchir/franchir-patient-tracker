...
export default function WorkflowTimeline({ currentStatus }: WorkflowTimelineProps) {
  const steps: {
    ...
    {
      status: 'medical_more_info',
      label: 'À compléter',
      shortLabel: 'Compléter',
      icon: <AlertCircle className="w-5 h-5" />,
    },
    {
      status: 'commercial_in_progress',
      label: 'Commercial',
      shortLabel: 'Devis',
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-red-700">
              Ce dossier a été refusé. Seul un administrateur peut le réouvrir.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-3 sm:p-4 md:p-6 mb-4 sm:mb-6 shadow-sm">
      <h3 className="text-xs sm:text-sm font-semibold text-gray-700 mb-3 sm:mb-4 md:mb-6">
        Parcours du dossier
      </h3>
