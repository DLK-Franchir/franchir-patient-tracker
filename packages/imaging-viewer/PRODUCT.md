...
| **U2**  | 0.15.2     | **done (code, flag off)** | Mesures Distance / Angle / Cobb non persistées, comparaison 2 viewports (scroll + W/L synchro), lignes de référence, ciné, MPR si volume homogène — **moteur Cornerstone seulement**. JPEG 2000 illisible → repli OpenJPEG. Message MPR en français.                                                                                             |
