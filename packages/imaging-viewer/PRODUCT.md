...
| **U2**  | 0.15.1     | **done (code, flag off)** | Mesures Distance / Angle / Cobb non persistées, comparaison 2 viewports (scroll + W/L synchro), lignes de référence, ciné, MPR si volume homogène — **moteur Cornerstone seulement**                                                                                                                                                            |
