...
| **U2** | done (0.15.3, flag off) | Distance / Angle / Cobb non persistées, 2 viewports synchro, lignes de référence, ciné, MPR si volume homogène — Cornerstone seulement ; JPEG 2000 illisible → même barre, outils impossibles grisés |
