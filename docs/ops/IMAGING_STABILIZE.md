...
- **U2 done (0.15.1, flag off, Cornerstone seulement)** — Distance / Angle / Cobb non persistées, comparaison 2 vues (scroll + W/L), lignes de référence, ciné, MPR si `isValidVolume`. dwv ne les expose pas.
